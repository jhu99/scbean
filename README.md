...
- [VIMCCA](https://scbean.readthedocs.io/en/latest/tutorials/index.html#tutorials-for-scbean-vimcca) supports joint-analysis of paired multimodal single-cell data (unpublished).
